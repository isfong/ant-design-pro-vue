        ...
        <a-form id="formLogin" class="user-layout-login" ref="formLogin" :form="form" @submit="handleSubmit">
            <a-tabs :activeKey="customActiveKey" :tabBarStyle="{ textAlign: 'center', borderBottom: 'unset' }"
                ...
                <a-tab-pane key="tab1" tab="账号密码登录">
                    <a-alert v-if="isLoginError" type="error" showIcon="true" style="margin-bottom: 24px;"
            ...
            <a-form-item>
                ...
                <router-link :to="'/passport/sign-up'" class="forge-password"
                             style="float: right;">
                    忘记密码
                </router-link>
            </a-form-item>
            ...
            <a-form-item style="margin-top:24px">
                <a-button size="large" type="primary" htmlType="submit" shape="round" class="login-button"
            ...
            <div class="user-login-other">
                ...
                <router-link class="register" :to="'/passport/sign-up'">注册账户</router-link>
            </div>
        </a-form>
