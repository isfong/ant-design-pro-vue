...
<script>
    import ConsoleFooter        from '@/views/console/console-footer/ConsoleFooter';
    import ConsoleSideMenu      from '@/views/console/console-side-menu/ConsoleSideMenu';
    import ConsoleSettingDrawer from '@/views/console/console-setting-drawer/ConsoleSettingDrawer';
